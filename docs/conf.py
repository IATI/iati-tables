...
# -*- coding: utf-8 -*-
#
# IATI Tables documentation build configuration file,
...
latex_documents = [
    (master_doc, "sphinx.tex", "IATI Tables Docs", "Open Data Services", "manual"),
]
...
man_pages = [(master_doc, "sphinx", "IATI Tables Docs", [author], 1)]
