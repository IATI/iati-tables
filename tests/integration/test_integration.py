        ...
        expected_rows=[
            {
                ...
                "humanitarian": True,
                "hierarchy": Decimal(1),  # FIXME: Should be int
                ...
                "plannedstart": datetime.datetime(2012, 4, 15),  # FIXME: Should be date
                "actualstart": datetime.datetime(2012, 4, 28),  # FIXME: Should be date
                "plannedend": datetime.datetime(2015, 12, 31),  # FIXME: Should be date
                ...
                "crsadd_loanstatus_valuedate": datetime.datetime(
                    2013, 5, 24
                ),  # FIXME: Should be date
                ...
                "fss_extractiondate": datetime.datetime(
                    2014, 5, 6
                ),  # FIXME: Should be date
                "fss_priority": True,
    ...
    assert_table_contents(
        ...
        expected_rows=[
            ...
            },
            {
                ...
                "type": "2",
                "typename": "Objectives",
                "narrative": "Objectives for the activity, for example from a logical framework., FR: Objectifs de l'activit\u00e9, par exemple \u00e0 partir d'un cadre logique.",
            },
            {
                ...
                "narrative": "Statement of groups targeted to benefit from the activity., FR: D\u00e9claration de groupes cibl\u00e9s pour b\u00e9n\u00e9ficier de l'activit\u00e9.",
            },
        ],
    )
